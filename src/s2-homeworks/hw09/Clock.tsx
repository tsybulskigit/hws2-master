...
function Clock() {
    ...
    const stringDate = `${date.getDate().toString().padStart(2, '0')}.${date.getMonth().toString().padStart(2, '0')}.${date.getFullYear().toString().padStart(2, '0')}` ||
    ...
    const stringDay = dayDictionary[date.getDay()] || <br/> // пишут студенты
    const stringMonth = monthDictionary[date.getMonth()] || <br/> // пишут студенты
